...
public class CatalogoServiceImpl implements ICatalogoService {
	...
	public List<DisenioLookup> findAllMarca() {
		return em.createQuery("from DisenioLookup where tipo_lookup='Marca' and Estatus=1 ORDER BY idLookup ASC")
				.getResultList();
	}
	...
	public DisenioLookup findLastComposicion() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Composicion' ORDER BY idLookup DESC")
	...
	public DisenioLookup findLastMarcador() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Marcador' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastMaterial() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Material' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastUnidadMedida() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Unidad Medida' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastInstrCuidado() {
		return (DisenioLookup) em
				.createQuery("from DisenioLookup where tipo_lookup='Instruccion Cuidado' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastFamComposicion() {
		return (DisenioLookup) em
				.createQuery("from DisenioLookup where tipo_lookup='Familia Composicion' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastFamGenero() {
		return (DisenioLookup) em
				.createQuery("from DisenioLookup where tipo_lookup='Familia Genero' ORDER BY idLookup DESC").setMaxResults(1)
				.getSingleResult();
	}
	...
	public DisenioLookup findLastFamPrendas() {
		return (DisenioLookup) em
				.createQuery("from DisenioLookup where tipo_lookup='Familia Prenda' ORDER BY idLookup DESC").setMaxResults(1)
				.getSingleResult();
	}
	...
	public DisenioLookup findLastPzasTrazo() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Pieza Trazo' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
	...
	public DisenioLookup findLastColor() {
		return (DisenioLookup) em.createQuery("from DisenioLookup where tipo_lookup='Color' ORDER BY idLookup DESC")
				.setMaxResults(1).getSingleResult();
	}
