...
public class DisenioMaterialTelaServiceImpl implements IDisenioMaterialTelaService {
	...
	public List<Object[]> findAllById(Long id) {
		// TODO Auto-generated method stub
		return em.createQuery("Select dm.idMaterial,dmt.tipo,dm.nombreMaterial,dmt.color,dmt.codigoColor,dmt.posicion from DisenioMaterialTela dmt inner join DisenioMaterial dm on dm.idMaterial=dmt.idMaterial where dmt.idTela="+id+" order by dmt.tipo,dm.nombreMaterial,dmt.posicion").getResultList();
	}
