...
public class ProduccionDetalleServiceImpl  implements IProduccionDetalleService {
	...
	public List<Object []> PrendaOrdenes(Long id) {
		// TODO Auto-generated method stub
		List<Object[]> re= em.createNativeQuery("select lookup.nombre_lookup, prenda.descripcion_prenda, orden.costo, SUM(orden.cantidad), orden.talla, orden.largo, orden.id_detalle_pedido, orden.id_prenda, orden.id_pedido\r\n" + 
				...
				"				GROUP BY orden.id_prenda").getResultList();
		return re;
	}
	...
	@Override
	@Transactional
	public void bajasOrdenes(String fecha,
			String edito,
			String idPrenda,
			String idPedido,
			String talla,
