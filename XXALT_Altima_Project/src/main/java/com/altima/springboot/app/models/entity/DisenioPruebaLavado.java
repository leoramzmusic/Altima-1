...
@Entity
@Table(name = "alt_disenio_prueba_lavado")
public class DisenioPruebaLavado implements Serializable{
	...
	@Id
	@Column(name="id_prueba_lavado")
	@GeneratedValue(strategy=GenerationType.AUTO, generator="native")
	@GenericGenerator(name="native",strategy="native")
	private Long idPruebaLavado;
	...
	public void setIdPruebaLavado(Long idPruebaLavado) {
		this.idPruebaLavado = idPruebaLavado;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisenioPruebaLavado other = (DisenioPruebaLavado) obj;
		...
		if (idCalidad == null) {
			...
			return false;
		if (idPruebaLavado == null) {
			if (other.idPruebaLavado != null)
				return false;
		} else if (!idPruebaLavado.equals(other.idPruebaLavado))
			return false;
		if (idText == null) {
