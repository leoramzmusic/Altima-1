...
@Entity
@Table(name = "alt_disenio_prueba_contaminacion")
public class DisenioPruebaContaminacion implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisenioPruebaContaminacion other = (DisenioPruebaContaminacion) obj;
