        ...
        success: (data) => {
            ...
            for (i in data) {
                ...
                a = [
                    ...
                    "</td>",
                    " <td>" +
                    "<button onclick='editarMedida(this);' idlookup='" + data[i].idLookup + "' nombre='" + data[i].nombreLookup + "'  class='btn btn-warning btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Editar'><i class='fas fa-pen'></i></button>&nbsp;" +
                    "<button onclick='bajarMedida(" + data[i].idLookup + ")' class='btn btn-danger btn-circle btn-sm popoverxd' data-container='body' data-toggle='popover' data-placement='top' data-content='Dar de baja'><i class='fas fa-chevron-down'></i></button>&nbsp;" +
                    "</td>" +
            ...
            var tablaUnidad = $('#idtable8').DataTable({
                "data": b,
                "ordering": false,
	            "pageLength": 5,
	            "responsive": true,
            ...
            new $.fn.dataTable.FixedHeader(tablaUnidad);
        },
        error: (e) => {
            // location.reload();
        }
...
function agregarComposicion() {
    Swal.fire({
        ...
        html: '<div class="row">' +
            ...
            '<input type="text" class="form-control" id="composicion" placeholder="Algodón">' +
            '</div>' +
            '<div class="form-group col-sm-12">' +
...
function editarComposicion(e) {
    ...
    Swal.fire({
        ...
        html: '<div class="row">' +
            ...
            '<input type="text" value="' + e.getAttribute("nombre") + '" class="form-control" id="nombre" placeholder="Algodón">' +
            '</div>' +
            '<div class="form-group col-sm-12">' +
